...
JNIEXPORT jint JNICALL
Java_com_mobileer_oboetesteradded_oboetester_TestAudioActivity_startNative(JNIEnv *env, jobject) {
...
JNIEXPORT jint JNICALL
Java_com_mobileer_oboetesteradded_oboetester_OboeAudioStream_getOboeVersionNumber(JNIEnv *env,
                                                                          jclass type) {
