...
import com.mobileer.androidfxlab.MainActivity;
import com.mobileer.oboetesteradded.oboetester.OboeMainActivity;
...
public class LandingPageActivity extends Activity implements View.OnClickListener {
   ...
   //     findViewById(R.id.ivOboeTester).setOnClickListener(this);
        findViewById(R.id.ivFxLab).setOnClickListener(this);
    }
    @Override
   ...
   /*         case R.id.ivOboeTester :
                intent = new Intent(this, OboeMainActivity.class);
                startActivity(intent);
                break;
